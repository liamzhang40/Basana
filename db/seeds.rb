...
Task.create!(project_id: project1.id, assignee_id: user1.id, name: 'Task1')
Task.create!(project_id: project1.id, name: 'Task2')
Task.create!(project_id: project1.id, assignee_id: user1.id, name: 'Task3')
Task.create!(project_id: project1.id, name: 'Task4')
Task.create!(project_id: project2.id, assignee_id: user1.id, name: 'Task5')
Task.create!(project_id: project2.id, name: 'Task6')
Task.create!(project_id: project3.id, name: 'Task7')
Task.create!(project_id: project3.id, assignee_id: user2.id, name: 'Task8')
Task.create!(project_id: project4.id, name: 'Task9')
Task.create!(project_id: project4.id, name: 'Task10')
Task.create!(project_id: project5.id, assignee_id: user3.id, name: 'Task11')
Task.create!(project_id: project6.id, assignee_id: user3.id, name: 'Task12')
Task.create!(assignee_id: user3.id, name: 'Task13')
Task.create!(assignee_id: user3.id, name: 'Task14')
