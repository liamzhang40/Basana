...
Project.create!(creator_id: user3.id, team_id: team1.id, name: 'Project1', description: 'Something')
Project.create!(creator_id: user3.id, team_id: team1.id, name: 'Project2', description: 'Something')
Project.create!(creator_id: user3.id, team_id: team1.id, name: 'Project3', description: 'Something')
Project.create!(creator_id: user2.id, team_id: team2.id, name: 'Project4', description: 'Something')
Project.create!(creator_id: user2.id, team_id: team2.id, name: 'Project5', description: 'Something')
Project.create!(creator_id: user1.id, team_id: team3.id, name: 'Project6', description: 'Something')
